/**
 * Created by tvanheerebeek on 12-02-14.
 */
/*****************************************************************************
 DATE HELPERS
...
Date.prototype.format = function(fmt) {
    ...
    // SET DUTCH LANGUAGE
    var f_nl_months = ['Januari','Februari','Maart','April','Mei','Juni','Juli','Augustus','September','Oktober','November','December'];
    ...
    for (i=0;i<fmt_matches.length;i++) {
        ...
        if (previous_match != match) {
            ...
            switch(match) {
                ...
                // SET DUTCH LANGUAGE
                case '%N':  re = /%N/g; val = f_nl_months[this.getMonth()]; break;
